...
struct PieSegment: Shape {
    ...
    private func getAngle() -> Angle {
        ...
        return -Angle.init(degrees: calculatedRatio * 360.0)
    }
    ...
    func path(in rect: CGRect) -> Path {
        ...
        path.move(to: center)
        path.addArc(center: center, radius: rect.midX, startAngle: -.degrees(90), endAngle: getAngle() - .degrees(90), clockwise: true)
        return path
    }
}
